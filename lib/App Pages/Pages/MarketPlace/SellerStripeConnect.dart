import 'package:agrisync/App%20Pages/Pages/MarketPlace/StripeConnectWebView.dart';
import 'package:agrisync/App%20Pages/Pages/MarketPlace/StripeService.dart';
...
class _SellerStripeConnectState extends State<SellerStripeConnect> {
  ...
  final StripeService _stripeService = StripeService(useMock: true); // Use mock mode
