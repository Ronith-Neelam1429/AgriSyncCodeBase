      ...
      for (var doc in snapshot.docs) {
        try {
          ...
          final equipment = EquipmentListing(
            ...
            retailer: equipmentData['retailer'] ?? '', listedBy: '',
          );
          ...
          if (change.type == DocumentChangeType.added) {
            try {
              ...
              final seed = EquipmentListing(
                ...
                retailer: seedData['retailer'] ?? '', listedBy: '',
              );
          ...
          if (change.type == DocumentChangeType.added) {
            try {
              ...
              final fertilizer = EquipmentListing(
                ...
                retailer: fertilizerData['retailer'] ?? '', listedBy: '',
              );
          ...
          if (change.type == DocumentChangeType.added) {
            try {
              ...
              final irrigation = EquipmentListing(
                ...
                retailer: irrigationData['retailer'] ?? '', listedBy: '',
              );
          ...
          if (change.type == DocumentChangeType.added) {
            try {
              ...
              final pesticide = EquipmentListing(
                ...
                retailer: pesticideData['retailer'] ?? '', listedBy: '',
              );
          ...
          if (change.type == DocumentChangeType.added) {
            try {
              ...
              final tool = EquipmentListing(
                ...
                retailer: toolData['retailer'] ?? '', listedBy: '',
              );
