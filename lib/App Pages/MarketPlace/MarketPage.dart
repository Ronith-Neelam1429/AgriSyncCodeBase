import 'package:agrisync/App%20Pages/MarketPlace/AddLIstingPage.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Service/DatabaseService.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Equipment/EquipmentPage.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Fertilizers/FertilizerPage.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Irrigation/IrrigationPage.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Service/NotificationModel.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Pesticides/PesticidePage.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Seeds/SeedsPage.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Seller/BankAccountLink.dart';
import 'package:agrisync/App%20Pages/MarketPlace/Tools/ToolsPage.dart';
  ...
  try {
    ...
    if (userDoc.exists) {
      ...
      if (userData.containsKey('isSeller') && userData['isSeller'] == true) {
        // User is already a seller, navigate to the add listing page
        Navigator.push(
          context,
