...
class _IrrigationPageState extends State<IrrigationPage> {
  ...
  RangeValues _priceRange = const RangeValues(0, 1000); // Adjusted for irrigation equipment pricing
  ...
  Stream<List<EquipmentListing>> getFilteredListings() {
    ...
    Query query = _firestore.collection('marketPlace')
        .where('list', isEqualTo: 'Irrigation');
              ...
              child: Container(
                ...
                child: TextField(
                  decoration: InputDecoration(
                    hintText: 'Search irrigation equipment...',
