                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      _buildQuickAction(
                        ...
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Crop Health feature coming soon!')),
                          );
                        },
                      ),
                      _buildQuickAction(
                      ...
                      _buildQuickAction(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const TaskScheduler()),
                          );
                        },
                      ),
                    ],
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          _buildActivityRow('Completed Task: Water Crops', '10 mins ago'),
                          const Divider(color: Colors.grey),
                          _buildActivityRow('Added Note: Crop Observation', '1 hour ago'),
                          const Divider(color: Colors.grey),
